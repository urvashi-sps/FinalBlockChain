...
//       />
//         { !purchased
//           ? <button className="flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd] mx-auto"
//               name={id}
//               value={price}
//               onClick={(event) => {
...
//               Buy
//             </button>
//           : <button className="flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd] mx-auto">Sold Out!</button>
//         }
//         </div>
//       </div>
//     </div>
